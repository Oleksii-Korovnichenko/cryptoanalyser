...
public class CryptoAlphabet {
    ...
    public static final String LATIN = "abcdefghijklmnopqrstuvwxyz";
    public static final String LATIN_WITH_NUMBERS = LATIN + NUMBERS;
    public static final String UKR = "абвгґдеєжзиіїйклмнопрстуфхцчшщьюя";//АБВГҐДЕЄЖЗИІЇЙКЛМНОПРСТУФХЦЧШЩЬЮЯ
